...
// Type: Innova.Launcher.Shared.Tracking.Models.Application.InstallerClosedUserEvent
...
{
  public class InstallerClosedUserEvent : UserEventBase
  {
    public InstallerClosedUserEvent()
      : base("users.installer.closed")
    {
    }
  }
}
