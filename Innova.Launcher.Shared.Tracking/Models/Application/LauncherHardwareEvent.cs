...
// Type: Innova.Launcher.Shared.Tracking.Models.Application.LauncherHardwareEvent
...
{
  public sealed class LauncherHardwareEvent : UserEventBase
  {
    ...
    public LauncherHardwareEvent()
      : base("users.launcher.hardware")
    {
    }
  }
}
