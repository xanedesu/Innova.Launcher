...
// Type: Innova.Launcher.Shared.Tracking.Models.Application.LauncherRuntimeErrorUserEvent
...
{
  public class LauncherRuntimeErrorUserEvent : UserEventBase
  {
    ...
    public LauncherRuntimeErrorUserEvent()
      : base("users.launcher.runtime.error")
    {
    }
