...
// Type: Innova.Launcher.Shared.Tracking.Models.Application.LauncherClosedEvent
...
{
  public class LauncherClosedEvent : UserEventBase
  {
    [JsonProperty("launcherVersion")]
    public string LauncherVersion { get; set; }

    public LauncherClosedEvent()
      : base("users.launcher.closed")
    {
    }
  }
}
